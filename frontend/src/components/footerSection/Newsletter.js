    ...
    <section className="bg-background py-16 md:py-20">
      <div className="container-page max-w-4xl">
        <div className="text-center">
          <p className="font-inter text-primary text-xs md:text-sm font-semibold tracking-widest uppercase mb-3">
            Newsletter
          </p>
          <h2 className="font-inter text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
            Stay Updated
          </h2>
